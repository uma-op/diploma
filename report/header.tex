...
% Заголовок без номера (иначе при secnumdepth < 3 в titlesec остаётся \thesubsubsection «…0»)
...
\newcounter{cyrapx}
\renewcommand{\thecyrapx}{%
  \ifcase\value{cyrapx}\or
  А\or Б\or В\or Г\or Д\or Е\or Ж\or З\or И\or К\or
  \else\arabic{cyrapx}\fi
}
\makeatother
\newcommand{\anonsection}[1]{\cleardoublepage
\phantomsection
\addcontentsline{toc}{anonsection}{#1}
\section*{#1}\vspace*{2.5ex} % По госту положены 3 пустые строки после заголовка ненумеруемого раздела
}
\newcommand{\anonappendix}{\cleardoublepage
\refstepcounter{cyrapx}%
\phantomsection
\addcontentsline{toc}{anonsection}{ПРИЛОЖЕНИЕ \thecyrapx}
\section*{ПРИЛОЖЕНИЕ \thecyrapx}\vspace*{2.5ex}
}
...
\setlength{\cftsecnumwidth}{2.5em}% Ширина поля номера раздела в оглавлении

% Ненумеруемые разделы (anonsection) — без поля номера, текст с левого поля
\makeatletter
\newcommand*{\l@anonsection}[2]{%
  \ifnum \c@tocdepth >\z@
...
\NewDocumentCommand{\caseof}{m m m o}{%
  \mathrm{case}\,#1\,\mathrm{of}\,#2\,\mathrm{or}\,#3%
  \IfValueT{#4}{:#4}%
}
